...
A Sinatra learning project focused on creating a performant API that receives a JSON file with 100,000 users and provides well-structured, high-performance endpoints for data analysis.
...
- Use appropriate Sinatra patterns (controllers, services, models, etc.)
...
- This is a learning project focused on Sinatra patterns and performance optimization
- The project uses in-memory storage (simulating a database)
- Performance is critical - all endpoints must respond in < 1 second
- Code should demonstrate Sinatra best practices while maintaining readability
